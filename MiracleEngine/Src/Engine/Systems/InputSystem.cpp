...
{
	return Vector3{ (float)(_p.x - (_GlobalContainer._windowSystem->getWindow().GetWindowWidth()) / 2.0f),
	  (float)(_GlobalContainer._windowSystem->getWindow().GetWindowHeight() / 2.0f) - _p.y, 1.0f };
}
