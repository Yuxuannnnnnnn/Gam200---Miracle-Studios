...
void GameObject::Serialise(std::string file)
{
	...
	int i = 0;
	//auto ComponentTypes = _GlobalContainer._prefabFactory->GetComponentTypes();
...
IComponent* GameObject::AddComponent(ComponentId componentType, ScriptId script)
{
	...
	IComponent* newComponent = _GlobalContainer._gameObjectFactory->AddComponent(this, componentType, script);
...
void GameObject::RemoveComponent(ComponentId componentType, ScriptId script)
{
	...
	_GlobalContainer._gameObjectFactory->RemoveComponent(this, componentType, script);
...
{
	_GlobalContainer._gameObjectFactory->DestoryGameObject(this);
}
