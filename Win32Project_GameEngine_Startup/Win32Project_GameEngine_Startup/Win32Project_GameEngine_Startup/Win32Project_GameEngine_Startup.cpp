// Win32Project_GameEngine_Startup.cpp : Defines the entry point for the application.
//

#include "header.h"
#include "Win32Project_GameEngine_Startup.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_WIN32PROJECTGAMEENGINESTARTUP, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WIN32PROJECTGAMEENGINESTARTUP));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WIN32PROJECTGAMEENGINESTARTUP));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)CreateSolidBrush(RGB(0,255,0));// (COLOR_WINDOW + 1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_WIN32PROJECTGAMEENGINESTARTUP);
    ...
    case WM_COMMAND:
        {
            ...
            case IDM_EXIT:
                ...
                break;
			case ID_FILE_TITLE:
				SetWindowText(hWnd, L"LATEST VERSION");
				break;
            default:
...
INT_PTR CALLBACK About(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_INITDIALOG:
		...
		SetWindowPos(hDlg, 0, rect.left + 100, rect.top + 100, 422, 300, SWP_SHOWWINDOW);
        return (INT_PTR)TRUE;
