...
void render_text(const std::string& str, FT_Face face, float xpos, float ypos, float x, float y, float sx, float sy, GLuint& program) {
...
void DisplayText(const std::string& text, float posX, float posY)
{
	...
	const float SCALEX = 2.0f / WIDTH;
	const float SCALEY = 2.0f / HEIGHT;
	FT_Set_Pixel_Sizes(face, 0, 50);
	render_text(text, face, posX , posY, -0.5, 0, SCALEX, SCALEY, program);
}